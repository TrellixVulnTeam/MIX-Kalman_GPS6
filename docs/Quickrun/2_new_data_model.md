...
In this part, we use [LXMERT](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/lxmert/LXMERT.md) model and VQA task as an example.
...
3. Prepare base configs
   ...
   You should set the configuration path of the model, dataset, and default runtime in the `configs` directory. (e.g. [LXMERT model and VQA task](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/lxmert/lxmert_vqa.py)).
