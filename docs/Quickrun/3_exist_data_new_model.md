...
- download the feature and annotation files like `train2014`, `imdb_train2014.npy`, `glove.6B.50d.txt.pt` and so on. You can download the data file according to the original paper or source code of [MCAN](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/mcan/MCAN.md);
...
4. Prepare base config
   ...
   You should set the configuration path of the model, dataset, schedule, and runtime in the `configs` directory. (e.g. [MCAN model and VQA task](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/mcan/mcan_vqa.py)).
