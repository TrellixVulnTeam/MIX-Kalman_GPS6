...
- Download the feature and annotation files like `train.json`, `trainval_ans2label.json`, `train2014_obj36.tsv` and so on. You can download the data file according to the original paper or source code of [LXMERT](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/lxmert/LXMERT.md);
...
Test LXMERT model and VQA task through single machine. Config and model checkpoint file is available [here](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/lxmert/).
...
MIX-Kalman provides out-of-the-box tools for training models. This section introduce how to train _predefined_ models (under [configs](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs)) on existing datasets (i.e. VQA).
...
Train LXMERT model and VQA task through single machine. Config and model checkpoint file is available [here](https://github.com/inspur-hsslab/MIX-Kalman/tree/master/configs/lxmert/).
